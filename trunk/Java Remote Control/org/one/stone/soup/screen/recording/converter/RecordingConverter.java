...
public class RecordingConverter implements ControllerListener, DataSinkListener {
	public static void main(String[] args)
	{
		try {
			...
			{
				System.out
						.println("Usage: JavaRecordingToMovie <screenRecording> <movieFile (currenly .mov or .avi supported)> [width height (optional)]");
				return;
			}
			...
			{
				recordingConverter.process(args[0], args[1], Integer
	...
	{
		MediaLocator mediaLocator = new MediaLocator(new File(movieFile).toURL());
